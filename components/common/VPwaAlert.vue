<template>
  <client-only>
    <div
      ...
      class="absolute bottom-4 right-4 max-w-xs flex flex-col gap-4 rounded-lg p-4 font-medium text-gray-200 shadow-lg from-stone-800 to-stone-600 bg-gradient-to-tr hover:shadow-md"
      role="alert"
    >
