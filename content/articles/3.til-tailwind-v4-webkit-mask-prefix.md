...
When a Tailwind utility "just works" and your hand-rolled CSS version does not, check what Tailwind actually compiled the utility to. It frequently emits vendor-prefixed fallbacks that you have to reproduce yourself once you leave the utility layer.
